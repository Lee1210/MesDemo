...
namespace Mes.Core.Data.Entity
{
    ...
    public class CodeFirstDbContext : DbContext, IUnitOfWork, IDependency
    {
        ...
        {
            string name = ConfigurationManager.AppSettings.Get("Mes-ConnectionStringName") ?? "default";
            return name;
        }
        ...
        private static bool DataLoggingEnabled
        {
            get
            {
                return ConfigurationManager.AppSettings.Get("Mes-DataLoggingEnabled").CastTo(false);
            }
        }
        ...
        internal int SaveChanges(bool validateOnSaveEnabled)
        {
            ...
            catch (DbUpdateException e)
            {
                if (e.InnerException != null && e.InnerException.InnerException is SqlException)
                {
                    ...
                    throw new MesException("提交数据更新时发生异常：" + msg, sqlEx);
                }
                throw;
            }
            finally
