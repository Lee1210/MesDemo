...
namespace Mes.Demo.Contracts.TestLog
{
    public partial interface ITestLogContract : IDependency
    {
        ...
        bool CheckCpkExists(Expression<Func<Cpk, bool>> predicate, int id = 0);
        ...
        OperationResult AddCpks(params CpkDto[] dtos);
        ...
        /// <returns>业务操作结果</returns>
        OperationResult EditCpks(params CpkDto[] dtos);
