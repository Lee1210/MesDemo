...
namespace Mes.Demo.Contracts.TestLog
{
    public partial interface IHrContract : IDependency
    {
        ...
        /// 获取产线 信息查询数据集
        /// </summary>
        IQueryable<TemporaryCard> TemporaryCards { get; }
        ...
        bool CheckTemporaryCardExists(Expression<Func<TemporaryCard, bool>> predicate, int id = 0);
        ...
        OperationResult AddTemporaryCards(params TemporaryCardDto[] dtos);
        ...
        /// <returns>业务操作结果</returns>
        OperationResult EditTemporaryCards(params TemporaryCardDto[] dtos);
        ...
        /// <returns>业务操作结果</returns>
        OperationResult DeleteTemporaryCards(params int[] ids);
