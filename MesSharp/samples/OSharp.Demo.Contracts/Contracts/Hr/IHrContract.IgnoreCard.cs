...
namespace Mes.Demo.Contracts.TestLog
{
    public partial interface IHrContract : IDependency
    {
        ...
        /// 获取产线 信息查询数据集
        /// </summary>
        IQueryable<IgnoreCard> IgnoreCards { get; }
        ...
        bool CheckIgnoreCardExists(Expression<Func<IgnoreCard, bool>> predicate, int id = 0);
        ...
        OperationResult AddIgnoreCards(params IgnoreCardDto[] dtos);
        ...
        /// <returns>业务操作结果</returns>
        OperationResult EditIgnoreCards(params IgnoreCardDto[] dtos);
        ...
        /// <returns>业务操作结果</returns>
        OperationResult DeleteIgnoreCards(params int[] ids);
